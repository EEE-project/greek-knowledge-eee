...
description: Imperative endings, negative commands built on μη(ν) + the subjunctive
  form, and the weak clitic that follows an affirmative imperative but precedes a
  negative one.
tags:
- verb
- imperative
