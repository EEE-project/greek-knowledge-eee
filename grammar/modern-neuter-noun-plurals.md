...
title: modern-neuter-noun-plurals
description: Common Modern Greek neuter noun plural endings.
tags:
- morphology
- noun
- neuter
...
Modern Greek neuter nouns take the plural article **τα** in both nominative and accusative, and the noun's own ending shifts too, usually with the stress staying on the same syllable as in the singular (in a **-μα** noun stressed on the third syllable from the end it moves one syllable to the right: **το μάθημα → τα μαθήματα**). Three endings cover most common vocabulary: **-ο → -α** (**το βιβλίο → τα βιβλία**, **το τηλέφωνο → τα τηλέφωνα**), **-ι → -ια** (**το παιδί → τα παιδιά**, **το σπίτι → τα σπίτια**), and **-μα → -ματα** (**το γράμμα → τα γράμματα**, **το πράγμα → τα πράγματα**).[^livexp-grammar]
