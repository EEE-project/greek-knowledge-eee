...
[[`references/sources/patrologia-graeca.md`](patrologia-graeca.md)](patrologia-graeca.md) for a
...
[`okfbuild/sources/lsj_periods.py`](../../okfbuild/sources/lsj_periods.py), matching LSJ citations against
Diorisis's catalog and LSJ's own front matter to resolve a historical
period — see
[[`references/sources/lsj.md`](lsj.md)](lsj.md#perioddialect-stratification). This
