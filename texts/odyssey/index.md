...
`translations_en.md` (Pope, Murray), `translations_ru.md` (Жуковский,
Вересаев), `translations_el.md` (Πολυλάς), and `interlinear_en.md`/
`interlinear_el.md` (word-by-word gloss, IX.19-38 only). Populated by
